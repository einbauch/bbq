...
// Скрываем форму добавления комментария и показываем её по клику на ссылку
$(function(){
    $('.event-comment-form').hide();

    $('.event-comment-form-link').click(function(){
        $('.event-comment-form').slideToggle(300);
        return false;
    });
});
